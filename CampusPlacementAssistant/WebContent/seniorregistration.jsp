	...
	<div id="main">
		...
		<div id="site_content">
			<div id="content">
				...
				%>
				<h1 style="text-align:center">Senior Registration</h1>
				<%
					}
				%>
				...
				<form action="VoidmainServlet" method="post" name="appform" style=" width: 50vw; margin-left : 15vw;">
					...
					<input type="hidden" name="type" value="com.voidmain.pojo.Senior">
					<input type="hidden" name="operation" value="add"> 
					<input type="hidden" name="redirect" value="seniorregistration.jsp">
					
					<input type="hidden" name="usertype" value="senior">
					...
					<div class="form_settings">
						...
						<p>
							<span>Roll Number</span><input class="contact" type="text"
								name="username" pattern="[1][67]BD1A0[0-9][0-9][A-Z 0-9]" title="roll number should start with 16 or 17 ex:16BD1A054X"value="" required="required"/>
						</p>
						<p>
							<span>Password</span><input class="contact" type="password"
								name="password" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}" value="" required="required"/>
						</p>
						<p>
